...
os.environ[
    "LI_AT_COOKIE"
] = "AQEDATL5DxIEeBgwAAABfNIMGqcAAAF89hiep1YANfMYAQlcYeXsiYLrUBscUe7kPTc2GmoiNqRu9EF8HGXGKFYtbIkVkea4q4mJtKUjQ5ChMqiBxu9zap0-Wkl2WxTXEeQCna7wOmJ45ewT13JH7wQL"
        ...
        if st.sidebar.checkbox("Login"):
            ...
            if result:
                ...
                if task == "Recommend":
                    ...
                    jum = st.number_input(
                        "Input Jumlah Iklan yang ingin Ditelusuri", 2, 100, 5
                    )  # mulai,max,default
                    ...
                    jumlah = st.number_input(
                        "Input Banyak Iklan yang ingin Ditampilkan", 2, 100, 10
                    )  # mulai,max,default
